 ...
 */
final class Version20260514140655 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE patient (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, age INT NOT NULL, username VARCHAR(255) NOT NULL, dni VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, disease VARCHAR(255) NOT NULL, observations VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
