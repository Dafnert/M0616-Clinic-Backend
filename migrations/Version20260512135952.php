 ...
 */
final class Version20260512135952 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE patient ADD dni VARCHAR(255) NOT NULL, ADD observations VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE patient DROP dni, DROP observations');
    }
}
